...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'thresholding.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('thresholding.wasm', import.meta.url).toString();
}
...
var ASM_CONSTS = {
  ...
  err('missing function: _ZN2cv3MatC1ERKS0_'); abort(-1);
  }

  /** @type {function(...*):?} */
  function __ZN2cv3MatC1Ev(
  ) {
  err('missing function: _ZN2cv3MatC1Ev'); abort(-1);
  }
  ...
  /** @type {function(...*):?} */
  function __ZN2cv7waitKeyEi(
  ) {
  err('missing function: _ZN2cv7waitKeyEi'); abort(-1);
  }

  /** @type {function(...*):?} */
  function __ZN2cv8cvtColorERKNS_11_InputArrayERKNS_12_OutputArrayEii(
  ) {
  err('missing function: _ZN2cv8cvtColorERKNS_11_InputArrayERKNS_12_OutputArrayEii'); abort(-1);
  }

  /** @type {function(...*):?} */
  function __ZN2cv9thresholdERKNS_11_InputArrayERKNS_12_OutputArrayEddi(
  ) {
  err('missing function: _ZN2cv9thresholdERKNS_11_InputArrayERKNS_12_OutputArrayEddi'); abort(-1);
  }

  /** @type {function(...*):?} */
  function __ZNK2cv3Mat5totalEv(
  ) {
  err('missing function: _ZNK2cv3Mat5totalEv'); abort(-1);
  }
...
var asmLibraryArg = {
  "_ZN2cv3MatC1ERKS0_": __ZN2cv3MatC1ERKS0_,
  "_ZN2cv3MatC1Ev": __ZN2cv3MatC1Ev,
  "_ZN2cv3MatD1Ev": __ZN2cv3MatD1Ev,
  "_ZN2cv7waitKeyEi": __ZN2cv7waitKeyEi,
  "_ZN2cv8cvtColorERKNS_11_InputArrayERKNS_12_OutputArrayEii": __ZN2cv8cvtColorERKNS_11_InputArrayERKNS_12_OutputArrayEii,
  "_ZN2cv9thresholdERKNS_11_InputArrayERKNS_12_OutputArrayEddi": __ZN2cv9thresholdERKNS_11_InputArrayERKNS_12_OutputArrayEddi,
  "_ZNK2cv3Mat5totalEv": __ZNK2cv3Mat5totalEv,
